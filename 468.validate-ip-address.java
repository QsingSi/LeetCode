 ...
 */
class Solution {
    private static final String NULL = "Neither";
    public String validIPAddress(String IP) {
        ...
        if (v4) {
            ...
            if (ips.length != 4)
                return NULL;
            for (String str : ips) {
                if (str.length() == 0 || str.length() > 3 || (str.charAt(0) > '9' || str.charAt(0) < '0') || str.charAt(0) == '0' && str.length() > 1)
                    return NULL;
