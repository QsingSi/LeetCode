 ...
 */
class Solution {
    private void helper(TreeNode rt) {
        if (rt == null)
            return;
        helper(rt.left);
        helper(rt.right);
        if (rt.left != null && rt.left.val == 0 && rt.left.left == null && rt.left.right == null)
            rt.left = null;
        if (rt.right != null && rt.right.val == 0 && rt.right.left == null && rt.right.right == null)
            rt.right = null;
    }
